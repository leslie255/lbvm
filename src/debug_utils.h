...
#define DEF_PRINT_FUNC(TY, FMT)                                                                                        \
  static inline void _print_##TY(TY x) { printf(FMT, x); }
...
static inline void _print_bool(bool x) { printf("%s\n", x ? "true" : "false"); }
static inline void _print_str(const char *x) { printf("%s\n", x); }

#define DEF_PRINT_HEX_FUNC(TY, FMT)                                                                                    \
  static inline void _print_hex_##TY(TY x) { printf("0x" FMT, x); }
...
#define PRINT_HEX(X)                                                                                                   \
  _Generic((X),                                                                                                        \
           ...
           u32: _print_hex_u32,                                                                                        \
           u64: _print_hex_u64,                                                                                        \
           usize: _print_hex_usize,                                                                                    \
           i8: _print_hex_i8,                                                                                          \
           i16: _print_hex_i16,                                                                                        \
           i32: _print_hex_i32,                                                                                        \
           i64: _print_hex_i64,                                                                                        \
           isize: _print_hex_isize)(X)
