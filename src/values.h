...
#define LIBC_gets       12
#define LIBC_fgets      13
#define LIBC_sprintf    14    
#define LIBC_snprintf   15    
#define LIBC_fopen      16
#define LIBC_fclose     17
#define LIBC_memcpy     18
#define LIBC_memmove    19
#define LIBC_memset     20
#define LIBC_bzero      21
#define LIBC_strlen     22
#define LIBC_strcpy     23
#define LIBC_strcat     24

#define CONDFLAG_FALSE 0b10000000
#define CONDFLAG_TRUE  0b00000000
...
#define CONDFLAG_NN    (CONDFLAG_N  | CONDFLAG_FALSE)
#define CONDFLAG_NZ    (CONDFLAG_Z  | CONDFLAG_FALSE)
#define CONDFLAG_NC    (CONDFLAG_C  | CONDFLAG_FALSE)
#define CONDFLAG_NV    (CONDFLAG_V  | CONDFLAG_FALSE)
#define CONDFLAG_NE    (CONDFLAG_E  | CONDFLAG_FALSE)
#define CONDFLAG_NG    (CONDFLAG_G  | CONDFLAG_FALSE)
#define CONDFLAG_NL    (CONDFLAG_L  | CONDFLAG_FALSE)
#define CONDFLAG_NGE   (CONDFLAG_GE | CONDFLAG_FALSE)
#define CONDFLAG_NLE   (CONDFLAG_LE | CONDFLAG_FALSE)
