...
#define OPCODE_FCMP        OPCODE(11)
#define OPCODE_CSEL        OPCODE(12)
#define OPCODE_B           OPCODE(13)
#define OPCODE_J           OPCODE(14)
#define OPCODE_ADD         OPCODE(15)  // ARITHMETICS
#define OPCODE_SUB         OPCODE(16)
#define OPCODE_MUL         OPCODE(17)
#define OPCODE_DIV         OPCODE(18)
#define OPCODE_MOD         OPCODE(19)
#define OPCODE_IADD        OPCODE(20)
#define OPCODE_ISUB        OPCODE(21)
#define OPCODE_IMUL        OPCODE(22)
#define OPCODE_IDIV        OPCODE(23)
#define OPCODE_IMOD        OPCODE(24)
#define OPCODE_FADD        OPCODE(25)
#define OPCODE_FSUB        OPCODE(26)
#define OPCODE_FMUL        OPCODE(27)
#define OPCODE_FDIV        OPCODE(28)
#define OPCODE_FMOD        OPCODE(29)
#define OPCODE_INEG        OPCODE(30)
#define OPCODE_FNEG        OPCODE(31)
#define OPCODE_SHL         OPCODE(32)
#define OPCODE_SHR         OPCODE(33)
#define OPCODE_AND         OPCODE(34)
#define OPCODE_OR          OPCODE(35)
#define OPCODE_XOR         OPCODE(36)
#define OPCODE_NOT         OPCODE(37)
#define OPCODE_MULADD      OPCODE(38)
#define OPCODE_CALL        OPCODE(39)
#define OPCODE_CCALL       OPCODE(40)
#define OPCODE_RET         OPCODE(41)
#define OPCODE_PUSH        OPCODE(42)
#define OPCODE_POP         OPCODE(43)
#define OPCODE_LIBC_CALL   OPCODE(44)
#define OPCODE_NATIVE_CALL OPCODE(45)
#define OPCODE_VTOREAL     OPCODE(46)
